...
*/
        case '90':	$groupname='Професійна програма підвищення кваліфікації державних службовців (6 група оплати праці). Термін навчання: 04-15 вересня 2017 року.'; $groupmembers=50; break;
        case '91':	$groupname='Тематичний короткостроковий семінар «Європейські стандарти демократичного врядування». Термін навчання: 07-08 вересня 2017 року.'; $groupmembers=53; break;
		case '92':	$groupname='Тематичний короткостроковий семінар «Україна-НАТО: напрями співробітництва та партнерства». Термін навчання: 07-08 вересня 2017 року.'; $groupmembers=56; break;
		case '93':	$groupname='Тематичний короткостроковий семінар «Інноваційні технології в публічному управлінні». Термін навчання: 11-12 вересня 2017 року.'; $groupmembers=49; break;
		case '94':	$groupname='Тематичний короткостроковий семінар «Смарт-технології». Термін навчання: 14-15 вересня 2017 року.'; $groupmembers=72; break;

        case '95':	$groupname='Тематичний короткостроковий семінар «Стратегічне управління та планування». Термін навчання: 18-19 вересня 2017 року.'; $groupmembers=104; break;
        case '96':	$groupname='Тематичний короткостроковий семінар «Управління змінами». Термін навчання: 21-22 вересня 2017 року.'; $groupmembers=57; break;
		case '97':	$groupname='Професійна програма підвищення кваліфікації державних службовців (7-9 группи оплати праці). Термін навчання: 02-13 жовтня 2017 року.'; $groupmembers=70; break;
		case '98':  $groupname='Тематичний короткостроковий семінар «Крос-культурний менеджмент. Крос-культурні комунікації та взаємодія». Термін навчання: 02-03 жовтня'; $groupmembers=54; break;
		case '99':  $groupname='Тематичний короткостроковий семінар «Медіація в публічному управлінні». Термін навчання: 09-10 жовтня'; $groupmembers=40; break;
		case '100': $groupname='Тематичний короткостроковий семінар «Медіаграмотність та медіакультура державних службовців». Термін навчання: 16-17 жовтня'; $groupmembers=79; break;
		case '101': $groupname='Тематичний короткостроковий семінар «Тайм-менеджмент». Термін навчання: 18-19 жовтня'; $groupmembers=98; break;
		case '102': $groupname='Тематичний короткостроковий семінар «Децентралізація влади та децентралізація фінансів в Україні». Термін навчання: 01-02 листопада'; $groupmembers=64; break;
		case '103': $groupname='Тематичний короткостроковий семінар «Управління проектами та програмами». Термін навчання: 06-07 листопада'; $groupmembers=92; break;
		...
		case '105': $groupname='Тематичний короткостроковий семінар «Антикризове управління в умовах модернізації державного управління». Термін навчання: 15-16 листопада'; $groupmembers=61; break;
		case '106': $groupname='Тематичний короткостроковий семінар «Цифрові технології». Термін навчання: 27-28 листопада'; $groupmembers=75; break;
		case '107': $groupname='Тематичний короткостроковий семінар «Корпоративна культура». Термін навчання: 29-30 листопада'; $groupmembers=77; break;
/*		
